...
import static basic.stream.trade.City.BUSAN;
import static basic.stream.trade.City.GYEONG_GI;
import static basic.stream.trade.City.INCHEAN;
import static basic.stream.trade.City.SEOUL;
import static java.util.stream.Collectors.groupingBy;
import static java.util.stream.Collectors.joining;
import static java.util.stream.Collectors.summingInt;
import static java.util.stream.Collectors.toList;

import basic.stream.dicegame.Dice;
import basic.stream.dicegame.Game;
import basic.stream.trade.City;
import basic.stream.trade.Trader;
import basic.stream.trade.Transaction;
