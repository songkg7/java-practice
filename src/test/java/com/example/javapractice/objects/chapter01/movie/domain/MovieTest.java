...
import com.example.javapractice.objects.chapter01.movie.condition.PeriodCondition;
import com.example.javapractice.objects.chapter01.movie.condition.SequenceCondition;
import com.example.javapractice.objects.chapter01.movie.policy.AmountDiscountPolicy;
import com.example.javapractice.objects.chapter01.movie.policy.NoneDiscountPolicy;
import com.example.javapractice.objects.chapter01.movie.policy.PercentDiscountPolicy;
