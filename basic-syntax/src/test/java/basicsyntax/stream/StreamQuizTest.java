...
import static basicsyntax.stream.trade.City.BUSAN;
import static basicsyntax.stream.trade.City.GYEONG_GI;
import static basicsyntax.stream.trade.City.INCHEAN;
import static basicsyntax.stream.trade.City.SEOUL;
import static java.util.stream.Collectors.groupingBy;
import static java.util.stream.Collectors.joining;
import static java.util.stream.Collectors.summingInt;
import static java.util.stream.Collectors.toList;

import basicsyntax.stream.dicegame.Dice;
import basicsyntax.stream.dicegame.Game;
import basicsyntax.stream.trade.City;
import basicsyntax.stream.trade.Trader;
import basicsyntax.stream.trade.Transaction;
